...
import com.app.reelsdownloader.BuildConfig;
...
public class AdmobAds {
    public static String PKG_APP = "com.app.downloadreels";
    ...
    public static void loadNativeAds(Activity activity, final View view) {
        ...
        final NativeAdView nativeAdView = (NativeAdView) activity.findViewById(R.id.native_ad_view);
